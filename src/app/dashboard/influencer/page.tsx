  ...
  return (
    <div className="min-h-[100dvh] bg-charcoal-deep">
      ...
      <div className="max-w-[1200px] mx-auto px-5 py-10">
        ...
        <div className="border-b border-white/8 mb-10 pb-10">
          {profileLoading ? (
            ...
            <div className="flex items-end justify-between flex-wrap gap-6">
              ...
              {/* Left: name + handle */}
              <div>
                <p className="font-serif text-[10px] tracking-[0.4em] uppercase text-champagne/70 mb-3">
                  Bonjour
                </p>
                ...
                {profile?.handle && (
                  <a
                    ...
                    className="font-serif text-[13px] text-champagne/70 hover:text-champagne transition-colors tracking-widest"
                  >
                    @{profile.handle}
                  </a>
                )}
              ...
              <div className="flex items-end gap-8 flex-wrap">
                ...
                {profile?.followers != null && profile.followers > 0 && (
                  <div className="text-right">
                    <p className="font-serif text-[10px] tracking-[0.3em] uppercase text-white/55 mb-1">
                      Abonnés
                    </p>
                    <p className="font-serif text-[32px] font-light text-white/85 leading-none">
                ...
                <div className="text-right">
                  ...
                  {monthlyCredit > 0 && (
                    <p className="font-serif text-[11px] text-white/55 mt-1">
            ...
            <button
              ...
              className={`font-serif text-[11px] tracking-[0.2em] uppercase px-4 py-2 transition-all duration-200 ${
                catFilter === c
                  ...
                  : "text-white/65 border border-white/15 hover:border-champagne/50 hover:text-champagne"
              }`}
            >
        ...
        {/* Label */}
        <p className="font-serif text-[11px] tracking-[0.35em] uppercase text-champagne/65 mb-8">
        ...
        {offersLoading ? (
          ...
          <div className="text-center py-24 border border-white/10">
            <p className="font-serif text-[15px] font-light text-white/75 mb-2">
              Aucune adresse disponible pour le moment.
            </p>
            <p className="font-serif text-[13px] font-light text-white/50 italic">
            ...
            {offers.map((offer) => (
              <div key={offer.id} className="bg-charcoal-deep group relative overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="font-serif text-[12px] text-white/60 mb-3 tracking-wide">
                    {offer.comercios?.name}
                  </p>
                  {offer.description && (
                    <p className="font-serif text-[13px] font-light text-white/70 leading-relaxed mb-4 line-clamp-2">
                      {offer.description}
                    </p>
                  )}
                  ...
                  {offer.visit_value_cop > 0 && (
                    <p className="font-serif text-[11px] text-champagne/70 mt-3">
