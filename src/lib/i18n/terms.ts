  ...
  sections: [
      ...
      blocks: [
        ...
        "Règles de fonctionnement du Crédit :",
        {
          list: [
            ...
            "Le Crédit peut être utilisé en une ou deux Visites distinctes au cours du même mois, dans la limite d'une visite par Maison.",
            "Chaque Maison fixe librement la valeur en euros de l'expérience qu'elle propose. Si l'expérience choisie excède le montant du Crédit, le Créateur peut librement couvrir la différence.",
            "En cas de clôture du compte (par le Créateur ou par Curato), tout Crédit non utilisé est définitivement perdu.",
          ],
        },
        "**Engagement d'utilisation mensuelle.** Le Créateur s'engage à utiliser au minimum soixante pour cent (60%) de son Crédit mensuel chaque mois calendaire. Le non-respect répété de cet engagement peut donner lieu à un avertissement et, en cas de récidive, à une revue du compte conformément à l'article 16.",
        "**Première vague de lancement.** Les Créateurs admis durant la première vague de lancement de Curato bénéficient d'un Crédit mensuel doublé par rapport au crédit standard de leur tier. Ce bénéfice est pérenne tant que le compte du Créateur reste actif sans interruption. En cas de clôture du compte (par le Créateur ou par Curato), le bénéfice est définitivement perdu et ne peut être restauré lors d'une éventuelle réinscription. Lorsque le Créateur évolue vers un tier supérieur, le bénéfice s'applique au crédit standard de son nouveau tier.",
      ],
    },
    {
      id: "creator-visites",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          list: [
            "Format obligatoire : deux (2) stories Instagram. Les Reels et publications en feed sont bienvenus mais non obligatoires.",
            "Délai : dans les vingt-quatre (24) heures suivant la Visite.",
      ...
      blocks: [
        ...
        "Durant cette période de 90 jours, la licence est :",
        {
          list: [
            ...
            "**Strictement limitée aux canaux propres de la Maison** : ses réseaux sociaux institutionnels, son site internet, ses campagnes d'emailing et ses supports de communication imprimés.",
            "**Non sub-licenciable** : la Maison ne peut pas céder, transférer ou accorder de sous-licence sur le Contenu à un tiers (agences de relations presse, agences de marketing, médias, partenaires commerciaux ou tout autre tiers), sauf accord écrit préalable du Créateur.",
            "**Sans publicité payante** : la Maison ne peut pas utiliser le Contenu dans le cadre de campagnes publicitaires payantes (Meta Ads, Google Ads, TikTok Ads ou équivalents), sauf accord écrit préalable du Créateur.",
          ],
        },
        "**Au-delà des 90 jours**, la licence devient non exclusive (le Créateur peut alors concéder le Contenu à d'autres tiers, y compris des concurrents) mais reste perpétuelle, mondiale et gratuite, en conservant le même périmètre restreint aux canaux propres de la Maison, sans sub-licence ni publicité payante.",
    ...
    },
    {
      ...
      blocks: [
        "La Maison peut télécharger et conserver le Contenu pour les besoins de son exploitation sur ses propres canaux, dans le respect de la Politique de Confidentialité et des durées de conservation qui y sont définies.",
        "Toute utilisation du Contenu en dehors des canaux propres de la Maison (par exemple en publicité payante ou par l'intermédiaire d'un tiers) nécessite l'accord écrit préalable du Créateur, conformément à l'article 20.",
        "Si le Créateur supprime le Contenu original de son propre compte, la Maison conserve néanmoins l'usage du Contenu déjà téléchargé pour la durée restant à courir de la licence et dans son périmètre.",
  ...
  sections: [
      ...
      blocks: [
        ...
        "Credit rules:",
        {
          list: [
            ...
            "The Credit may be used over one or two distinct Visits within the same month, with a limit of one visit per House.",
            "Each House sets the euro value of the experience it offers. If the chosen experience exceeds the Credit amount, the Creator may freely cover the difference.",
            "Upon account closure (by the Creator or by Curato), any unused Credit is permanently lost.",
          ],
        },
        "**Monthly usage commitment.** The Creator undertakes to use at least sixty percent (60%) of their Monthly Credit each calendar month. Repeated failure to meet this commitment may lead to a warning and, in case of recidivism, to an account review under section 16.",
        "**Launch first wave.** Creators admitted during Curato's launch first wave benefit from a Monthly Credit doubled relative to the standard credit of their tier. This benefit is permanent as long as the Creator's account remains continuously active. Upon account closure (by the Creator or by Curato), the benefit is permanently lost and cannot be restored in case of subsequent re-registration. When the Creator moves up to a higher tier, the benefit applies to the standard credit of the new tier.",
      ],
    },
    {
      id: "creator-visites",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          list: [
            "Mandatory format: two (2) Instagram stories. Reels and feed posts are welcome but not mandatory.",
            "Deadline: within twenty-four (24) hours following the Visit.",
      ...
      blocks: [
        ...
        "During this 90-day period, the licence is:",
        {
          list: [
            ...
            "**Strictly limited to the House's own channels**: its institutional social media, its website, its email campaigns and its printed communication materials.",
            "**Non-sublicensable**: the House may not assign, transfer or grant any sub-licence on the Content to any third party (PR agencies, marketing agencies, media, commercial partners or any other third party), save with prior written consent of the Creator.",
            "**No paid advertising**: the House may not use the Content as part of paid advertising campaigns (Meta Ads, Google Ads, TikTok Ads or equivalents), save with prior written consent of the Creator.",
          ],
        },
        "**Beyond 90 days**, the licence becomes non-exclusive (the Creator may then grant the Content to other third parties, including competitors) but remains perpetual, worldwide and royalty-free, retaining the same restricted scope limited to the House's own channels, without sub-licensing or paid advertising.",
    ...
    },
    {
      ...
      blocks: [
        "The House may download and retain the Content for the needs of its operation on its own channels, in compliance with the Privacy Policy and the retention periods defined therein.",
        "Any use of the Content outside the House's own channels (for example in paid advertising or via a third party) requires the prior written consent of the Creator, in accordance with section 20.",
        "If the Creator deletes the original Content from their own account, the House nonetheless retains the use of the Content already downloaded for the remainder of the licence term and within its scope.",
  ...
  sections: [
      ...
      blocks: [
        ...
        "Reglas de funcionamiento del Crédito:",
        {
          list: [
            ...
            "El Crédito puede utilizarse en una o dos Visitas distintas dentro del mismo mes, con un límite de una visita por Maison.",
            "Cada Maison fija libremente el valor en euros de la experiencia que ofrece. Si la experiencia elegida supera el monto del Crédito, el Creador puede cubrir libremente la diferencia.",
            "En caso de cierre de la cuenta (por el Creador o por Curato), todo Crédito no utilizado se pierde definitivamente.",
          ],
        },
        "**Compromiso de uso mensual.** El Creador se compromete a utilizar al menos el sesenta por ciento (60%) de su Crédito mensual cada mes natural. El incumplimiento repetido de este compromiso puede dar lugar a una advertencia y, en caso de reincidencia, a una revisión de la cuenta conforme a la sección 16.",
        "**Primera vague de lanzamiento.** Los Creadores admitidos durante la primera vague de lanzamiento de Curato se benefician de un Crédito mensual doblado respecto al crédito estándar de su tier. Este beneficio es perenne mientras la cuenta del Creador permanezca activa sin interrupción. En caso de cierre de la cuenta (por el Creador o por Curato), el beneficio se pierde definitivamente y no puede restaurarse en caso de una eventual reinscripción. Cuando el Creador evoluciona hacia un tier superior, el beneficio se aplica al crédito estándar de su nuevo tier.",
      ],
    },
    {
      id: "creator-visites",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          list: [
            "Formato obligatorio: dos (2) stories de Instagram. Los Reels y publicaciones en feed son bienvenidos pero no obligatorios.",
            "Plazo: en las veinticuatro (24) horas siguientes a la Visita.",
      ...
      blocks: [
        ...
        "Durante este periodo de 90 días, la licencia es:",
        {
          list: [
            ...
            "**Estrictamente limitada a los canales propios de la Maison**: sus redes sociales institucionales, su sitio web, sus campañas de email marketing y sus soportes de comunicación impresos.",
            "**No sublicenciable**: la Maison no puede ceder, transferir ni otorgar sublicencia sobre el Contenido a un tercero (agencias de relaciones con prensa, agencias de marketing, medios, partners comerciales ni ningún otro tercero), salvo acuerdo escrito previo del Creador.",
            "**Sin publicidad pagada**: la Maison no puede usar el Contenido en el marco de campañas publicitarias pagadas (Meta Ads, Google Ads, TikTok Ads o equivalentes), salvo acuerdo escrito previo del Creador.",
          ],
        },
        "**Más allá de los 90 días**, la licencia pasa a ser no exclusiva (el Creador puede entonces otorgar el Contenido a otros terceros, incluidos competidores) pero permanece perpetua, mundial y gratuita, conservando el mismo perímetro restringido a los canales propios de la Maison, sin sublicencia ni publicidad pagada.",
    ...
    },
    {
      ...
      blocks: [
        "La Maison puede descargar y conservar el Contenido para las necesidades de su explotación en sus canales propios, respetando la Política de Privacidad y los plazos de conservación allí definidos.",
        "Toda utilización del Contenido fuera de los canales propios de la Maison (por ejemplo en publicidad pagada o vía un tercero) requiere el acuerdo escrito previo del Creador, conforme a la sección 20.",
        "Si el Creador suprime el Contenido original de su propia cuenta, la Maison conserva no obstante el uso del Contenido ya descargado por la duración restante de la licencia y dentro de su perímetro.",
