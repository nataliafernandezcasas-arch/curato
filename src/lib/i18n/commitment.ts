...
const LABELS: Record<Lang, CommitmentLabels> = {
  fr: {
    ...
    terms: [
      ...
      "Puis un abonnement mensuel de 299 € TTC pour rejoindre le cercle Curato.",
      ...
      "Curato vous garantit un minimum de 5 visites de storytellers par mois. Si ce seuil n'est pas atteint, le mois suivant vous est offert.",
      "Ce minimum se mesure sur les visites que Curato vous propose : une demande que vous refusez compte comme une visite proposée.",
    ],
  ...
  en: {
    ...
    terms: [
      ...
      "Then a monthly subscription of 299 € including tax to join the Curato circle.",
      ...
      "Curato guarantees a minimum of 5 storyteller visits per month. If that threshold is not met, the following month is free.",
      "That minimum is measured on the visits Curato offers you: a request you decline counts as a visit offered.",
    ],
  ...
  es: {
    ...
    terms: [
      ...
      "Luego una suscripción mensual de 299 € impuestos incluidos para unirte al círculo Curato.",
      ...
      "Curato te garantiza un mínimo de 5 visitas de storytellers al mes. Si no se alcanza ese umbral, el mes siguiente es gratis.",
      "Ese mínimo se mide sobre las visitas que Curato te propone: una solicitud que rechaces cuenta como visita propuesta.",
    ],
