      ...
      blocks: [
        "Chaque traitement de données personnelles repose sur une base légale conforme à l'article 6 du RGPD :",
        {
          list: [
            ...
            "Présentation aux maisons membres des photographies et de la description de style jointes à la candidature d'un créateur admis (son portfolio). Base légale : exécution du contrat (art. 6.1.b), dans les conditions de l'article 15 des conditions générales.",
            "Utilisation de photographies du portfolio d'un créateur admis dans les communications de Curato (site, réseaux sociaux propres, newsletter, documents de présentation), avec mention de son nom. Base légale : exécution du contrat (art. 6.1.b), selon la licence prévue à l'article 15 des conditions générales.",
      ...
      blocks: [
        "Le modèle de Curato repose sur la transparence des relations entre créateurs et maisons. Cette section précise ce qui est visible par qui :",
        {
          list: [
            ...
            "Lorsqu'un créateur adresse une demande de visite à une maison, celle-ci voit en outre la demande (date, nombre de personnes, note éventuelle), un historique agrégé de ses visites dans Curato (nombre de visites et portée moyenne, sans le nom des autres maisons).",
      ...
      blocks: [
        "Vos données sont conservées pour la durée strictement nécessaire à la finalité du traitement :",
        {
          list: [
            ...
            "Photographies et description de style jointes à une candidature : supprimées avec la candidature si elle n'est pas retenue ; pour un créateur admis, conservées pendant la durée de son compte puis supprimées à sa clôture, ou plus tôt sur simple demande ; une photographie retirée n'est plus utilisée dans de nouveaux supports de Curato.",
      ...
      blocks: [
        "Each processing activity rests on a legal basis under Article 6 GDPR:",
        {
          list: [
            ...
            "Presenting to member houses the photographs and style description attached to an admitted creator's application (their portfolio). Legal basis: performance of the contract (Art. 6.1.b), under section 15 of the terms and conditions.",
            "Using photographs from an admitted creator's portfolio in Curato's communications (website, own social channels, newsletter, presentation documents), with their name credited. Legal basis: performance of the contract (Art. 6.1.b), under the licence in section 15 of the terms and conditions.",
      ...
      blocks: [
        "Curato's model rests on transparency in the relationship between creators and houses. This section specifies what is visible to whom:",
        {
          list: [
            ...
            "When a creator sends a visit request to a house, the house also sees the request (date, number of people, optional note), an aggregated history of their visits within Curato (number of visits and average reach, without the names of other houses).",
      ...
      blocks: [
        "Your data is kept for the time strictly necessary to the purpose of the processing:",
        {
          list: [
            ...
            "Photographs and style description attached to an application: deleted with the application if it is unsuccessful; for an admitted creator, kept for the life of their account and deleted when it is closed, or earlier on request; a photograph that has been removed is no longer used in new Curato materials.",
      ...
      blocks: [
        "Cada tratamiento de datos personales se basa en una base legal conforme al artículo 6 del RGPD:",
        {
          list: [
            ...
            "Presentación a las maisons miembro de las fotografías y la descripción de estilo adjuntas a la candidatura de un creador admitido (su portafolio). Base legal: ejecución del contrato (art. 6.1.b), en las condiciones de la sección 15 de las condiciones generales.",
            "Uso de fotografías del portafolio de un creador admitido en las comunicaciones de Curato (web, redes propias, newsletter, documentos de presentación), con mención de su nombre. Base legal: ejecución del contrato (art. 6.1.b), según la licencia de la sección 15 de las condiciones generales.",
      ...
      blocks: [
        "El modelo de Curato se basa en la transparencia en la relación entre creadores y maisons. Esta sección detalla qué es visible para quién:",
        {
          list: [
            ...
            "Cuando un creador envía una solicitud de visita a una maison, esta ve además la solicitud (fecha, número de personas, nota opcional), un historial agregado de sus visitas en Curato (número de visitas y alcance medio, sin el nombre de las otras maisons).",
      ...
      blocks: [
        "Tus datos se conservan durante el tiempo estrictamente necesario para la finalidad del tratamiento:",
        {
          list: [
            ...
            "Fotografías y descripción de estilo adjuntas a una candidatura: se eliminan con la candidatura si no es aceptada; en el caso de un creador admitido, se conservan mientras dure su cuenta y se eliminan al cerrarla, o antes a simple petición; una fotografía retirada deja de usarse en nuevos soportes de Curato.",
