...
// LEGACY generator, kept for EN and ES only.
//
// French maisons now receive the designed template in `assets/engagement-template-fr.pdf`
// (see commitment-pdf.ts). There is no EN or ES export of that design yet, so those
// languages keep this fully generated version rather than receiving a French document.
// Delete this file once the EN and ES templates exist.
...
export async function buildCommitmentPdfGenerated(input: {
  maisonName: string;
  signatory: string;
